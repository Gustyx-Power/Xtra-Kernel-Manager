...
/**
 * Quick Settings Tile for Performance Mode control. Allows cycling through performance modes from
 * the notification shade: balanced → performance → battery → balanced
 */

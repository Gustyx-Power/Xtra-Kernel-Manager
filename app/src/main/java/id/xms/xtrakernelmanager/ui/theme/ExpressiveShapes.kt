...
object ExpressiveShapes {
  ...
  val Slanted =
      RoundedCornerShape(topStart = 36.dp, topEnd = 12.dp, bottomStart = 12.dp, bottomEnd = 36.dp)

  // Arch (semicircle top)
  val Arch =
      RoundedCornerShape(topStart = 100.dp, topEnd = 100.dp, bottomStart = 16.dp, bottomEnd = 16.dp)
  ...
  val Semicircle = GenericShape { size, _ ->
    ...
    cubicTo(width, height * 0.85f, width * 0.85f, height, width * 0.6f, height)
  ...
  val Oval = GenericShape { size, _ ->
    ...
    cubicTo(
        radiusX + radiusX * 0.55f,
        height / 2f - radiusY,
        width,
        height / 2f - radiusY * 0.45f,
        width,
        height / 2f,
    )
    cubicTo(
  ...
  val Fan = GenericShape { size, _ ->
    ...
    moveTo(0f, 0f)
    lineTo(width, 0f)
    cubicTo(width, height * 0.4f, width * 0.6f, height, 0f, height)
    close()
  }
  ...
  val Heart = GenericShape { size, _ ->
    ...
    // Left curve
    cubicTo(width / 2f, height * 0.25f, width * 0.25f, height * 0.1f, width * 0.2f, height * 0.3f)
    cubicTo(width * 0.1f, height * 0.5f, width * 0.2f, height * 0.7f, width / 2f, height * 0.95f)

    // Right curve
    cubicTo(width * 0.8f, height * 0.7f, width * 0.9f, height * 0.5f, width * 0.8f, height * 0.3f)
    cubicTo(width * 0.75f, height * 0.1f, width / 2f, height * 0.25f, width / 2f, height * 0.35f)
  ...
  val Ghost = GenericShape { size, _ ->
    ...
    cubicTo(width * 0.2f, 0f, 0f, height * 0.2f, 0f, height * 0.45f)

    // Left side
    lineTo(0f, height * 0.8f)

    // Wavy bottom
    cubicTo(0f, height * 0.95f, width * 0.15f, height, width * 0.25f, height * 0.9f)
    cubicTo(width * 0.35f, height * 0.8f, width * 0.4f, height, width * 0.5f, height)
    cubicTo(width * 0.6f, height, width * 0.65f, height * 0.8f, width * 0.75f, height * 0.9f)
    cubicTo(width * 0.85f, height, width, height * 0.95f, width, height * 0.8f)

    // Right side
    lineTo(width, height * 0.45f)
    cubicTo(width, height * 0.2f, width * 0.8f, 0f, width * 0.5f, 0f)
  ...
  val Bun = GenericShape { size, _ ->
    ...
    // Right semicircle
    cubicTo(width - radius * 0.45f, 0f, width, radius * 0.45f, width, radius)
    cubicTo(width, radius + radius * 0.55f, width - radius * 0.45f, height, width - radius, height)

    lineTo(radius, height)

    // Left semicircle
    cubicTo(radius * 0.55f, height, 0f, radius + radius * 0.55f, 0f, radius)
    cubicTo(0f, radius * 0.45f, radius * 0.55f, 0f, radius, 0f)

            ...
            Column(modifier = Modifier.padding(24.dp), verticalArrangement = Arrangement.spacedBy(24.dp)) {
                ...
                Column(
                    ...
                    Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
                        ...
                        WhiteBatteryStatBox(label = stringResource(id.xms.xtrakernelmanager.R.string.frosted_battery_current), value = currentText, modifier = Modifier.weight(1f))
                        WhiteBatteryStatBox(label = stringResource(id.xms.xtrakernelmanager.R.string.frosted_battery_voltage), value = "${batteryInfo.voltage} mV", modifier = Modifier.weight(1f))
                    }
                    Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
                        WhiteBatteryStatBox(label = stringResource(id.xms.xtrakernelmanager.R.string.frosted_battery_temperature), value = "${batteryInfo.temperature}°C", modifier = Modifier.weight(1f))
                        WhiteBatteryStatBox(label = stringResource(id.xms.xtrakernelmanager.R.string.frosted_battery_cycle_count), value = "${batteryInfo.cycleCount}", modifier = Modifier.weight(1f))
                    }
                }
            }
        }

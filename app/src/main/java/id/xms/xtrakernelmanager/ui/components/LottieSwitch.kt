...
fun LottieSwitch(
    ...
    val composition by rememberLottieComposition(
        LottieCompositionSpec.RawRes(R.raw.switch_anim)
    )
...
/**
 * Simplified LottieSwitch that uses direct progress control for smoother animation.
 * This version provides more predictable behavior.
 */
@Composable
fun LottieSwitchSimple(
    ...
    val progress by animateLottieCompositionAsState(
        ...
        iterations = 1,
        restartOnPlay = false,
        clipSpec = com.airbnb.lottie.compose.LottieClipSpec.Progress(
            min = 0f,
            max = 0.5f
        )
    )
...
/**
 * Most reliable version - uses frame-based progress control.
 * This provides the smoothest and most predictable toggle animation.
 * 
 * @param checked Current toggle state
 * @param onCheckedChange Callback when toggle state changes
 * @param modifier Modifier for the switch

...
/**
 * Repository for Power Insight data Handles SOT calculation, drain rates, and battery statistics
 */
class PowerRepository {
  ...
  /**
   * Get screen on and off time using UsageStatsManager Returns Pair(screenOnTimeMs,
   * screenOffTimeMs)
   */

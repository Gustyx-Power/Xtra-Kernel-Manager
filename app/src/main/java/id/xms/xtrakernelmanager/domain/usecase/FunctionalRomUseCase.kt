...
/**
 * Use case for Functional ROM features.
 * Handles security validation, native kernel features, and property-based features.
 */
class FunctionalRomUseCase {
     ...
     */
    suspend fun checkVipCommunity(): Boolean = withContext(Dispatchers.IO) {
     ...
     */
    suspend fun findBypassChargingNode(): String? = withContext(Dispatchers.IO) {
     ...
     */
    suspend fun findChargingLimitNode(): String? = withContext(Dispatchers.IO) {
     ...
     */
    suspend fun setForceRefreshRate(hz: Int): Result<Unit> = withContext(Dispatchers.IO) {
     ...
     */
    suspend fun getCurrentRefreshRate(): Int = withContext(Dispatchers.IO) {
     ...
     */
    suspend fun resetRefreshRate(): Result<Unit> = withContext(Dispatchers.IO) {
